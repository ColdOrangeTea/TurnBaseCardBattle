...
public abstract class MapFlowHookBase : MonoBehaviour
{
    ...
    public virtual IEnumerator OnBeforeEvent(GridEventType type, EventGrid grid) { yield break; }
    /// <summary>事件結束後、恢復流程前。</summary>
    public virtual IEnumerator OnAfterEvent(GridEventType type, EventGrid grid) { yield break; }
