...
public class Endless_GM_MapTurnBaseManager : MonoBehaviour
{
    // public GridManager gridManager; // 用來管理格子
    public Endless_GM_GridManager gridManager; // 用來管理格子


    MapTurnBaseType currentTurn;
    private float playerMoveSpeed = 0; // 玩家移動速度

    public Endless_GM_S001_PlayerController playerController; //這個之後想修掉
    ...
    //                    Debug.Log("進入戰鬥 !");
    //                    // 預留轉場動畫的時間或效果
    //                    yield return new WaitForSeconds(3f); // 假設轉場動畫播放 3 秒
